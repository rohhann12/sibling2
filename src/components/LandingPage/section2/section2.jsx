...
function Section2() {
  return (
    <div className="section2-container">
      ...
      <p className='title'>We are here to help you <br />feel 
          <span className='title-blue'>better</span>
        </p>
      </div>
      <div className='image-onLeft'>
        <video src="https://d1jj76g3lut4fe.cloudfront.net/processed/thumb/75dKj8REUeZ9wqr0H4.mp4?Expires=1718819005&Signature=HPBoGEu0ZSivI2V4tkTLdGMmUEmuqyfNqCuLC4L96qEpgvzhB6Lr-YVo~HimkKR50jnDVmCOdJjAEUEO2Ck~5LFCPWmQ8oKRquxb9uDxLyk1IfNW6kk7OV4BjVYc-sfZC~CK6HiSb1qVbtNapqJSPijISOp4uyyJp077hbYH6huF7PbWVNtQ2tCH~9WQfPMIzFhY2pNJhsY-qFSgwsVvEYSk075sjvE1lHKpwvKzDP3UN9Wf5zAiux9K8cGm7w~OdHX3d-zgR9okY4h6A0v5zRwlYGjD-~mqy84VRAGYiNa2XAFdbwOXZdxinB~CL9VM5SkZOBX8h1WYJ7irtfabfw__&Key-Pair-Id=K2YEDJLVZ3XRI#t=0.001" alt="Description of the image" autoPlay={true} loop={true}/>
      </div>
      <div className='para'>
        <p className='main-para'>
          Caring for your mental health & wellness can be tough, but finding
          the right support doesn't have to be. Our upcoming newsletter will
          deliver valuable resources directly to your inbox, offering
          personalized tips to help you manage stress and anxiety, improve
          your sleep, and enhance your mindfulness. Relax your mind and
          start each day feeling like the best version of yourself.
        </p>
      </div>
